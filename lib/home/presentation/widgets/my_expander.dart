...
enum ExpanderDirection {
  ...
  /// Whether the [HorizontalExpander] expands left
  left,

  /// Whether the [HorizontalExpander] expands right
  right,
}

/// The [HorizontalExpander] control lets you show or hide less important content that's
...
class HorizontalExpander extends StatefulWidget {
  ...
  const HorizontalExpander({
    ...
    this.direction = ExpanderDirection.left,
  ...
  /// The alignment of the icon in the header.
  ...
  /// Whether the [HorizontalExpander] is initially expanded.
  ///
  /// Defaults to `false`
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty<ExpanderDirection>(
        'direction',
        direction,
        defaultValue: ExpanderDirection.left,
      ))
  ...
  @override
  State<HorizontalExpander> createState() => HorizontalExpanderState();
}

class HorizontalExpanderState extends State<HorizontalExpander>
  ...
  bool get _isRight => widget.direction == ExpanderDirection.right;
  ...
  Widget build(BuildContext context) {
    ...
    final children = [
      ...
      HoverButton(
        ...
        builder: (context, states) {
          return Container(
            ...
            alignment: widget.iconAlignment ?? (_isRight
      ...
      SizeTransition(
        ...
        axis: Axis.horizontal, // Modified line
        child: Container(
            ...
            shape: widget.contentShape?.call(_isExpanded) ??
                RoundedRectangleBorder(
                  ...
                  borderRadius: BorderRadius.horizontal(
                          // For left/right expansion
                          left: const Radius.circular(6.0),
                          right: Radius.circular(_isExpanded ? 0.0 : 6.0),
                        ),
                ),
    ...
    return Row(
            // Use a Row for horizontal expansion
            mainAxisSize: MainAxisSize.min,
            mainAxisAlignment:
                _isRight ?  MainAxisAlignment.start : MainAxisAlignment.end,
            crossAxisAlignment:
                CrossAxisAlignment.stretch, // You might need to adjust this
            children: _isRight ? children : children.reversed.toList(),
          );
